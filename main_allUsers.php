      ...
      $(function() {
        ...
        async function fetch_Network_API(){
          try{
				result = await $.ajax({
					type: "POST",
					url: "http://localhost/Facebook_Project-RewaShoujaa/API/get_allUsers.php",
					data: {
            userID:User_ID
                        },
    ...
    async function getSearchResults_API(SearchValue){
      //var Pending_Users;
          try{
				result = await $.ajax({
                   type: "POST",
                   url: "http://localhost/Facebook_Project-RewaShoujaa/API/search_allUsers.php",
                     data: {
                        userID: User_ID,
    ...
    async function Block_User_API(id){
      //var Pending_Users;
          try{
				result = await $.ajax({
					type: "POST",
					url: "http://localhost/Facebook_Project-RewaShoujaa/API/block_user.php",
					data: {
            AddedUserID:id,
            userID:User_ID
                        }
